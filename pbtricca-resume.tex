...
Dedicated to technical excellence in software design, implementation and documentation with a specific focus on security.
    ...
    \begin {itemize}
      ...
      \item Familiarity with requirements from IAD SFDE protection profile.
      \item Appropriate usage of OpenSSL APIs (EVP/RAND) for use in virtual full disk encryption and FIPS mode configuration.
